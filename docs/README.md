...
2. → Lee [RESUMEN-MODULOS.md](RESUMEN-MODULOS.md) (5 min)
3. → Lee [LEARNING-PATH.md](LEARNING-PATH.md) (10 min)
4. → Abre [Módulo 1](../modules/01-programming-math-for-ml/README.md)
