...
2. [MLOps: From Model to Production - Andrew Ng](https://www.youtube.com/watch?v=06-AZXmwHjo) - 1 hora
...
2. [CI/CD for ML - Google Cloud](https://www.youtube.com/watch?v=hFhZsDgZFfg) - 20 min
...
2. [Data Drift Explained - Evidently AI](https://www.youtube.com/watch?v=bKh6CTgHiLU) - 15 min
...
2. **Data drift detectado:** Distribución cambió.
3. **Scheduled:** Periódicamente (semanal, mensual).
4. **Nuevos datos disponibles:** Dataset creció significativamente.
...
2. Recolectar datos recientes.
3. Entrenar modelo.
4. Validar (métricas > umbral).
5. Registrar en model registry.
6. Desplegar con estrategia segura (canary).
7. Monitorear.
