...
2. [Deep Learning Crash Course - freeCodeCamp](https://www.youtube.com/watch?v=VyWAvY2CF9c) - 30 min
3. [Deep Learning Specialization - Andrew Ng (Coursera)](https://www.coursera.org/specializations/deep-learning) - curso completo certificable
...
2. [ReLU vs Sigmoid - Krish Naik](https://www.youtube.com/watch?v=4w3h6aPXKcQ) - 15 min
...
2. Aplicar activación: `A = σ(Z)`
3. Repetir para cada capa hasta llegar a la salida.
...
2. [Cross Entropy Explained - Aurélien Géron](https://www.youtube.com/watch?v=j_NJVqE8e9Y) - 15 min
...
2. Calcular gradiente de la pérdida respecto a la salida.
3. Propagar ese gradiente hacia atrás usando la regla de la cadena.
4. Actualizar pesos: `w = w - learning_rate * gradient`

📹 **Videos recomendados (CRÍTICOS):**
1. [Backpropagation Calculus - 3Blue1Brown](https://www.youtube.com/watch?v=tIeHLnjs5U8) - 10 min
2. [Backpropagation Explained - StatQuest](https://www.youtube.com/watch?v=IN2XmBhILt4) - 15 min
...
2. [Optimizers Explained - Andrej Karpathy](https://www.youtube.com/watch?v=IHZwWFHWa-w) - 46 min
...
2. [Dropout Explained - Krish Naik](https://www.youtube.com/watch?v=LN3qH5OI_lM) - 12 min
...
2. [TensorFlow 2.0 Complete Course](https://www.youtube.com/watch?v=tPYj3fFJGjk) - 7 horas
3. [PyTorch vs TensorFlow - Krish Naik](https://www.youtube.com/watch?v=sVm2FPi_WHQ) - 20 min
...
## Checklist de comprensión final
