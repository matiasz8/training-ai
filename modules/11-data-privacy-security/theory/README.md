...
2. [De-identification Techniques - NIST](https://www.youtube.com/watch?v=Y-KVJcXqsHw) - 20 min
...
2. [Access Control Models - Professor Messer](https://www.youtube.com/watch?v=VE4S4NLu3z0) - 15 min
...
2. [Adversarial ML - Two Minute Papers](https://www.youtube.com/watch?v=i1sp4X57TL4) - 5 min
...
2. **Privacidad por defecto:** Configuración más restrictiva por defecto.
3. **Privacidad embebida:** Parte integral del diseño.
4. **Funcionalidad completa:** No sacrificar usabilidad.
5. **Seguridad end-to-end:** Protección en todo el ciclo de vida.
6. **Visibilidad y transparencia:** Operaciones abiertas y verificables.
7. **Respeto por privacidad del usuario:** Centrado en el individuo.
