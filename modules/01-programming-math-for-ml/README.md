...
2. Ver videos recomendados en orden sugerido:
...
3. Tomar notas propias en `notes/TEORIA-RESUMEN.md`.
...
2. Ejecutar [examples/02-estadistica-descriptiva.md](./examples/02-estadistica-descriptiva.md).
3. Resolver ejercicios propuestos al final de cada ejemplo.
4. Documentar dudas o descubrimientos en `notes/`.
...
2. Resolver ejercicios propuestos de forma autónoma (Parte 2).
3. Repetir con [practice-02-algebra-lineal-aplicada.md](./practices/practice-02-algebra-lineal-aplicada.md).
4. Continuar con practices 03, 04, 05 (estadística, optimización, pipeline integrado).
5. Guardar código de soluciones en `practices/solutions/` (crear carpeta).

### Paso 4: Mini-proyecto (2-3 sesiones)
1. Leer enunciado completo en [mini-project/README.md](./mini-project/README.md).
2. Implementar regresión lineal desde cero con gradiente descendente.
3. Evaluar con métricas (MAE, RMSE, R²).
4. Documentar conclusiones y siguientes mejoras.

### Paso 5: Evaluación y cierre (1 sesión)
1. Completar [evaluation/README.md](./evaluation/README.md) (auto-evaluación).
2. Verificar puntaje mínimo >= 70/100.
3. Actualizar [STATUS.md](./STATUS.md) con nivel alcanzado y bloqueos resueltos.
4. Registrar lecciones principales en `notes/LECCIONES-APRENDIDAS.md`.
