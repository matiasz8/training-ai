...
2. 1 mini-proyecto transversal de extras (por ejemplo: LLM app con guardrails + evals + observabilidad).
3. Rubrica simple para extras (impacto real, reproducibilidad, seguridad, comunicación).
4. Evidencia en `notes/` o bitácora: decisiones, fallos y mejoras.
