...
2. [Generative AI Explained - Google Cloud](https://www.youtube.com/watch?v=G2fqAlgmoPo) - 15 min
...
2. [Diffusion Models Explained - AI Coffee Break](https://www.youtube.com/watch?v=fbLgFrlTnGU) - 20 min
...
2. **Tarea concreta:** ¿Qué debe hacer?
   ```
   Crea un plan de contenido para Instagram durante el próximo mes.
   ```

3. **Restricciones:** Límites y reglas.
   ```
...
5. **Criterio de calidad (opcional):**
   ```
...
2. [Advanced Prompting - DeepLearning.AI](https://www.deeplearning.ai/short-courses/chatgpt-prompt-engineering-for-developers/) - curso gratuito
...
2. **Relevancia:** ¿Responde la pregunta?
3. **Coherencia:** ¿Es lógico y consistente?
4. **Fluidez:** ¿Lee natural?
5. **Seguridad:** ¿Evita contenido dañino?
