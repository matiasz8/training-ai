...
[![Modules](https://img.shields.io/badge/Módulos-12%20Core%20%2B%206%20Avanzados-blue)]()
[![Language](https://img.shields.io/badge/Idioma-Español-red)]()
[![Examples](https://img.shields.io/badge/Ejemplos-60%2B%20Python-yellow)]()
...
├─ Módulo 06: Computer Vision
├─ Módulo 07: Time Series & Anomaly Detection
└─ Módulo 08: Recommender Systems
   └─ Checkpoint: Fine-tune LLM y deploy chatbot

FASE 3: Producción (2-3 meses)
├─ Módulo 09: Generative AI & Prompt Engineering
...
├── 🚀 mini-project/      → Proyecto integrador del módulo
└── ✅ evaluation/        → Autoevaluación y checklist
```
...
2. **Tipea el código** - No copies/pegues, escribe manualmente
3. **Modifica ejemplos** - Cambia hiperparámetros, observa resultados
4. **Documenta aprendizajes** - Usa `notes/` para tus descubrimientos
5. **Comparte proyectos** - Sube mini-projects a GitHub para portfolio
6. **Únete a comunidad** - Discord/Reddit de ML para dudas
...
2. **Sistema de recomendación** de películas con matrix factorization
3. **Clasificador de sentimientos** de reviews con fine-tuned BERT
4. **Detector de anomalías** en series temporales financieras
5. **Chatbot con RAG** respondiendo preguntas sobre documentos PDF
6. **Auditoría de bias** en modelo de scoring crediticio
7. **Pipeline ML completo** con CI/CD, monitoring y A/B testing
...
3. Commit tus cambios (`git commit -m 'feat: Agrega nueva práctica'`)
...
Este programa sintetiza conocimiento de:
...
### 🎓 De cero a AI Engineer — El viaje comienza aquí
